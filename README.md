...
shhgit comes with 156 signatures, including LLM provider API keys (OpenAI, Anthropic, Hugging Face, Groq, Cohere, Mistral). You can remove or add more by editing the `config.yaml` file.
